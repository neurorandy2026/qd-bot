...
async def answer_market_question(question: str, context: dict, api_key: str) -> str:
    ...
    system = (
        ...
        "El campo 'gamma_flip_mvc' es el MVC (Market Value Center) — el pivote del día. "
        "Si precio_sobre_mvc=true: mercado controlado sobre ese nivel. "
        "Si precio_sobre_mvc=false: mercado puede acelerar a la baja. "
