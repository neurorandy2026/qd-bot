...
async def answer_market_question(question: str, context: dict, api_key: str) -> str:
    ...
    system = (
        ...
        "El campo 'mvc' es el MVC (Market Value Center), calculado del DEX flip — "
        "el strike donde la presión de cobertura direccional de los market makers es neutral. "
        "Si precio_sobre_mvc=true: MMs compran para cubrirse → soporte estructural debajo del precio. "
        "Si precio_sobre_mvc=false: MMs venden para cubrirse → presión bajista estructural. "
        "El campo 'gamma_flip_pivote' es el pivote de volatilidad (GEX flip) — diferente al MVC. "
